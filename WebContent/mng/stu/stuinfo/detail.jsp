			...
			<section class="content">
				...
				<div class="col-md-12">
					...
					<div class="box box-info" style="border-radius: 12px;">
						...
						<!-- /.box-header -->
						<!-- form start -->
						<form class="form-horizontal" method = "post" action = "<%=request.getContextPath()%>/mng/stu/update?id=<%=stu.getId()%>">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入学生姓名" name="sname" id="sname" value="<%=stu.getSname()%>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入学生身份证号" name="idcard" id="idcard" value="<%=stu.getIdcard()%>">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入学生民族" name="nation" id="nation" value="<%=stu.getNation()%>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入学生政治面貌" name="political" id="political" value="<%=stu.getPolitical()%>">
									</div>
								</div>
									...
									<div class="col-sm-10">
										...
										<div class="input-group">
											<span class="input-group-addon"><i
												...
												name="birthday" class="form-control" id="birthday" value="<%=stu.getBirthday()%>"/>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入地址" name="address" id="address" value="<%=stu.getAddress()%>">
									</div>
								</div>
                             <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入生源地" name="source" id="source" value="<%=stu.getSource()%>">
									</div>
								</div>
								  <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入所在院校" name="school" id="school" value="<%=stu.getSchool()%>">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<div class="input-group">
											<span class="input-group-addon"><i
												class="fa  fa-calendar"></i></span> <input type="text"
												name="gradutetime" class="form-control" id="gradutetime" value="<%=stu.getGradutetime()%>"/>
										</div>
									</div>
								</div>
								  <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入所学专业" name="major" id="major" value="<%=stu.getMajor()%>">
									</div>
								</div>
								  <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入联系方式" name="mobile" id="mobile" value="<%=stu.getMobile()%>">
									</div>
								</div>
								  <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入曾用名" name="real_name" id="real_name" value="<%=stu.getRealname()%>">
									</div>
								</div>
								 <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											placeholder="请输入邮箱" name="email" id="email" value="<%=stu.getEmail()%>">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<textarea id="memo" name="memo" rows="15"
											cols="100" class="form-control"><%=stu.getMemo()%></textarea>
									</div>
								</div>
							</div>
							<!-- /.box-body -->
