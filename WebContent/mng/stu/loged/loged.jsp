<%@page import="com.zhonghuan.entity.Register"%>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					 登录用户详情 <small> <jsp:include page="../../icd_stu_time.jsp"></jsp:include>
					</small>
				</h1>
				...
				<ol class="breadcrumb">
					...
					<li>系统管理</li>
					<li class="active"><a href="javascript:;">登录用户详情</a></li>
				</ol>
			</section>
  <%
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											 name="oldpwd" id="oldpwd" value= "${curr_stu.login}"  disabled="disabled"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											 name="newpwd" id="newpwd" disabled="disabled" value="${curr_stu.regitster_time}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" 
											 name="okpwd" id="okpwd" value="${curr_stu.memo}" disabled="disabled" />
									</div>
								</div>
							<!-- /.box-footer -->
						</form>
